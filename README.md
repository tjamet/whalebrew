...
If you're not using Homebrew, you can download a binary and use that:
    ...
    curl -L "https://github.com/whalebrew/whalebrew/releases/download/0.0.0-alpha6/whalebrew-$(uname -s)-$(uname -m)" -o /usr/local/bin/whalebrew; chmod +x /usr/local/bin/whalebrew
